...
### Key points
- **Input**: GeoJSON configuration files define the year–month and tile code to process. *Now configured in [`./src/run_composites.py#L36`](https://github.com/fotakide/DieOffMonitoring/blob/d7919e6e5daf11907f5da8798c6e52fdb4a4029b/src/run_composites.py#L40).*
